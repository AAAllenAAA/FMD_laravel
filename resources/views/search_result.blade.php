...
<div class="container mb-3">
    <div class="d-flex justify-content-between align-items-start" style="background-color: #1c1c1e; color: #bbb; font-size: 0.9rem; padding: 1rem;">
        <div>
            @if ($key === '')
...
<script>
    $(document).ready(function () {
        const dynamicScrollY = window.innerHeight - 190 + "px";
        $('#datalist').DataTable({
            "lengthChange": false,
            "scrollX": true,
